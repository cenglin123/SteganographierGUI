...
1. 改进隐写方法，把，现在更多的解压软件可以解压 MP4 隐写文件，如 zarchiver，以及 3.x 版本的[解 TMD 压](https://cangku.moe/archives/216302)
- 改进前: [MP4 视频数据] + [moov + 隐藏数据] + [随机压缩标识]
- 改进后: [ftyp] + [free + 隐藏ZIP] + [其他MP4 atom] + [随机特征码1 + 随机数据] + [随机特征码2 + 随机数据] + [mdat结尾]
2. 修改外壳视频下拉选择框的样式
